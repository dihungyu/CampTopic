...
請輸入預估參加費用：<input type="text" name="leastAttendeeFee" id="leastAttendeeFee" value="<?php echo $leastAttendeeFee ?>"><br/>
請輸入最高預估參加費用：<input type="text" name="maxAttendeeFee" id="maxAttendeeFee" value="<?php echo $maxAttendeeFee ?>"><br/>
