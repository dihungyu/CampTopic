...
<body>
    ...
    <table border="1" align="center">
        ...
        while ($row_result = mysqli_fetch_assoc($result)) {
            ...
            echo "<td><a href='updateActivity.php?activityId=" . $row_result['activityId'] . "'>修改</a><br>";
            echo "<a href='deleteActivity.php?activityId=" . $row_result['activityId'] . "'>刪除</a><br>";
            echo "<a href='confirmActivity.php?activityId=" . $row_result['activityId'] . "'>審核</a><br>";
            echo "<a href='signupActivity.php?activityId=" . $row_result['activityId'] . "'>報名</a></td>'";
            echo "</tr>";
        }
        ?>
    </table>
