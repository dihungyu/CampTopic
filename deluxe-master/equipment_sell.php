...
// 查詢所有裝備總數
$equipment_count_sql = "SELECT COUNT(*) as total FROM equipments WHERE equipmentType='賣' $equipment_keyword_condition";
...
// 查詢所有裝備資料
$sql_equipments = "SELECT * FROM equipments WHERE equipmentType='賣' $equipment_keyword_condition LIMIT $equipment_perPage OFFSET $equipment_offset";
