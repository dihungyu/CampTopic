        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown  active">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <a class="dropdown-item  active" href="member-like.php">我的收藏</a>
            ...
            LIMIT $article_offset, $article_perPage";
              ...
              if ($articleResult && $articleResult->num_rows > 0) {
                ...
                while ($articleData = $articleResult->fetch_assoc()) {
                  ...
                  // 取得圖片路徑
                  $article_image_src = get_first_image_src($articleData["articleContent"]);
                  if ($article_image_src == "") {
                    $article_image_src = "images/news/img15.jpg";
                  } else {
                  ...
                  <div class='inner'>
                    <figure>
                      <a href='../article.php?articleId=" . $articleData["articleId"] . "'>
                        <img src='" . $article_image_src . "'>
                      </a>
                    </figure>
                    <div class='details'>
                      <div class='detail'style='display: flex;'>
                        <div class='category'>
                          <a href='../article.php?articleId=" . $articleData["articleId"] . "'>" . $articleData["accountName"] . "</a>
                        </div>
                        <div class='time'>" . $formatted_date . "</div>
                      </div>
                      <h5><a href='../article.php?articleId=" . $articleData["articleId"] . "'>" . $articleData["articleTitle"] . "</a>
                      <form action='member-like.php' method='post' class='d-inline'>
            ...
            if ($result && $result->num_rows > 0) {
              ...
              if ($equipmentResult && $equipmentResult->num_rows > 0) {
                ...
                while ($equipmentData = $equipmentResult->fetch_assoc()) {
                  ...
                  if ($equip_image_src == "") {
                    $equip_img_src = "images/image_8.jpg";
                  } else {
              ...
              <div class="innereq">';
                  ...
                  echo '<h5><a href="../equip-single.php?equipmentId=' . $equipmentData["equipmentId"] . '">' . $equipmentData['equipmentName'] . '</a></h5>';
