      ...
      <div class="row">
          ...
          <div class="row">
            <div class="col-md-11 ftco-animate">
              <div class="single-slider owl-carousel">
                <div class="item">
                  <div class="room-img" style="background-image: url(images/6540.jpg);"></div>
                </div>
              </div>
            </div>
            <div class="col-md-11 room-single mt-4 mb-5 ftco-animate">
              <h4 style="letter-spacing: 4px;">露營車環島 山與海的體驗 東北角新北瑞雙公路之旅</h4>
              <br>
              <p>位於臺102線公路上雙溪與九份交界處附近，坐落近年來東北角必造訪景點—不厭亭；<br>
                沿著瑞雙公路一路往台2線開，沿途經過九份老街、黃金博物館，最後抵達水湳洞十三層遺址。<br>
                一路從山玩到海，沿途風景的變化、一路上的休憩、移動，全靠一台福斯自走式露營車完成。
            </div>

            <div class="container mb-5">
              <h4 style="margin-bottom: 40px;">熱門文章</h4>
              <div class="row mb-5">
        ...
        <div class="col-lg-4 sidebar ftco-animate">
          <span class="all-article-top4">
            ...
            <div class="col-md-6 d-flex ftco-animate">
              <div class="blog-entry align-self-stretch">
                <a href="blog-single.html" class="block-20" style="background-image: url('../property-1.0.0/images/Rectangle\ 134.png');">
                </a>
                <div class="text mt-3 d-block">
                  <h3 class="heading2 mt-3">
                    <a href="#">溪谷型營區注意事項</a>
                  </h3>
                  <div class="meta2 mb-3">
                    <div><a href="#">Dec 6, 2018</a></div>
            ...
            <div class="col-md-6 d-flex ftco-animate">
              <div class="blog-entry align-self-stretch">
                <a href="blog-single.html" class="block-20" style="background-image: url('../property-1.0.0/images/Rectangle\ 138.png');">
                </a>
                <div class="text mt-3 d-block">
                  <h3 class="heading2 mt-3">
                    <a href="#">武陵櫻花季來了！<br>賞櫻不必自行開車</a>
                  </h3>
                  <div class="meta2 mb-3">
                    <div><a href="#">Dec 6, 2018</a></div>
                    <div><a href="#">Admin</a></div>
            ...
            <div class="col-md-6 d-flex ftco-animate">
              <div class="blog-entry align-self-stretch">
                <a href="blog-single.html" class="block-20" style="background-image: url('../property-1.0.0/images/Rectangle\ 137.png');">
                </a>
                <div class="text mt-3 d-block">
                  <h3 class="heading2 mt-3">
                    <a href="#">新竹露營！
